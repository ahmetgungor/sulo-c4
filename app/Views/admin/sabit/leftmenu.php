        ...
        <aside id="sidebar-wrapper">
          ...
          <ul class="sidebar-menu">
              ...
              <li class="nav-item dropdown">
                <a href="#" class="nav-link has-dropdown" data-toggle="dropdown"><i class="fas fa-columns"></i> <span>Kullanıcı İşlemleri</span></a>
                <ul class="dropdown-menu">
                  <li><a class="nav-link" href="layout-default.html">Kullanıcı Oluştur</a></li>
                  <li><a class="nav-link" href="layout-transparent.html">Onay Bekleyen Kullanıcılar</a></li>
                  <li><a class="nav-link" href="layout-top-navigation.html">Kullanıcı Grupları</a></li>
                </ul>
              </li>
