...
<head>
    <meta charset="utf-8">
    <link rel="stylesheet" href="<?=base_url()?>/mobil/assets/css/reset.css" />
    ...
    <link rel="stylesheet" href="<?=base_url()?>/mobil/assets/css/style.css?ver=<?rand(999,99999)?>" />
    ...
    <script src="<?=base_url()?>/mobil/assets/js/main.js?<?=rand(0,99999)?>"></script>
    <title>mobile-app</title>
</head>
<body class="hide-player">