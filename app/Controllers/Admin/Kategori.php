...
class kategori extends BaseController
{
    ...
    function indexPOST($tip=0, $yaziid=0)
    {
        ...
        if(!$page->save($data))
		{
			...
			return redirect()->to(base_url('admin/kategori/index/'.$tip.'/'.$yaziid.'?id='.$lastid))->with('success',
    ...
    function indexUPDATE($tip=0, $yaziid=0)
    {
        ...
        if(!$page->update($id,$data))
		{
			...
			return redirect()->to(base_url('admin/kategori/index/'.$tip.'/'.$yaziid.'?id='.$id))->with('success',
